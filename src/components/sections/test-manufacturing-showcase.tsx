...
const META = {
  ...
  submissionId: "20260808-013727-b07def99",
};
...
// メインコンポーネント
export default function TestManufacturingShowcase() {
            ...
            <div>
              ...
              <dl className="space-y-3">
                <div className="flex border-b border-slate-200 pb-3">
                  ...
                  <dd className="text-slate-900">テスト株式会社</dd>
                </div>
                <div className="flex border-b border-slate-200 pb-3">
      ...
      <footer className="bg-slate-900 py-12 text-white">
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          ...
          <div className="mt-12 border-t border-slate-800 pt-8 text-center text-sm text-slate-500">
            <p>&copy; 2024 テスト株式会社. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
