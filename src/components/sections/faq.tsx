...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      "初期費用は0円。お客様負担は独自ドメイン代（年間約1,500円前後）と、追加機能の個別見積もりのみです。",
  },
  {
    question: "何を準備すれば始められますか？",
    answer:
      "会社案内やパンフレット、写真、メモ書きだけでも大丈夫です。見せ方や構成はこちらで整理します。",
  },
  {
    question: "どんな業種でも対応できますか？",
    answer:
      "製造・建設・飲食・美容・整骨院・士業・IT・コンサルなど、中小企業向けに幅広く対応します。業種ごとに重視すべき情報を整理します。",
  },
  {
    question: "完成イメージは事前に確認できますか？",
    answer:
      "はい。業種別の完成例を見ながらご相談いただけます。見え方が分からないまま進めることはありません。",
  },
  {
    question: "更新は自分でできますか？",
    answer:
      "はい。お知らせ追加や画像差し替えなど、簡単な変更はご自身で可能です。難しい部分は当社が対応します。",
  },
  {
    question: "解約したら何も残りませんか？",
    answer:
      "いいえ。サイトのデータやソースコードはお客様の資産です。移行時も整理してお渡しします。",
  },
  {
    question: "検索対策は含まれますか？",
    answer:
      "はい。タイトル・見出し・スマホ対応・表示速度・業種や地名の整理など、検索の土台は最初から整えます。",
  },
  {
    question: "納期はどれくらいですか？",
    answer:
      "内容が固まっていれば、初稿は7営業日前後です。ページ数が多い場合や多言語対応の場合は別途調整します。",
  },
];
